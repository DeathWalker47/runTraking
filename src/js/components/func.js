...
class App {
  ...
  _loadMap(position) {
    ...
    document.querySelector('.sidebar img').addEventListener('click', this.reser);
    document.querySelector('.sidebar__top').addEventListener('click', this.addClassSidebar);
    // document.querySelector('.btn-type-sort-distance').addEventListener('click', this.sortElements);
    // document.querySelector('.btn-type-sort-distance').addEventListener('click', this.sortElements);
    // document.querySelector('.btn-type-sort-time').addEventListener('click', this.sortElements);
    // document.querySelector('.sort-btns__btns').addEventListener('click', this._sortType);
  ...
  addClassSidebar() {
   ...
   sortElements(sortBy = 'distance') {
    // let elements = document.querySelectorAll('[data-distance]');
    ...
    // var parent = document.querySelector('.workouts'); // Замените 'parent-element' на ID родительского элемента
